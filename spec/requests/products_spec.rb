...
RSpec.describe "/products", type: :request do
  ...
  let(:valid_attributes) {
    {name: "super bike", category_id: category.id, base_price: 1000, description: "super bike", in_stock: true}
  }

  let(:invalid_attributes) {
    {name: nil, category: nil, base_price: nil, description: nil, in_stock: nil}
  }
