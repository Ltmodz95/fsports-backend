...
RSpec.describe "/cart_items", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get api_v1_cart_items_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get api_v1_cart_item_url(cart_item), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested cart_item" do
        cart_item = CartItem.create! valid_attributes
        patch api_v1_cart_item_url(cart_item),
  ...
  describe "DELETE /destroy" do
    it "destroys the requested cart_item" do
      cart_item = CartItem.create! valid_attributes
      expect {
        delete api_v1_cart_item_url(cart_item), headers: valid_headers, as: :json
      }.to change(CartItem, :count).by(-1)
    end
  end
end
